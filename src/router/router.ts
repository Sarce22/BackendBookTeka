...
import { addBookToFavorites, checkUserRole, deleteUser, findUser, getAllUsers, insertUser, login, updateUser, validateTokenOk } from "../controllers/user.controller";
...
//Favoritos
router.post('/addBookToFavorites', addBookToFavorites);
